...
// ReactModuleWithSpec is needed for compatibility with RN 0.72
public abstract class NativeOneTapSignInSpec extends ReactContextBaseJavaModule implements ReactModuleWithSpec, TurboModule {
  ...
  @ReactMethod
  @DoNotStrip
  public abstract void checkPlayServices(boolean showPlayServicesUpdateDialog, Promise promise);
